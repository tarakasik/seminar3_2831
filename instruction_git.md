...
Для создания Pull request закачиваем изменения на удалённый репозиторий делаем закачивание изменений на удалённый репозиторий и на GitHub нажимаем *"Pull request"*
