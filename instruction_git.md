...
Для создания форка интересующего репозитория на GitHub находим интересующий нас репо и нажимаем (fork).
...
## Закачивание изменений на локальный репозиторий

Обновляться в данном случае будет локальный репозиторий из удалённого.

Для обновления локального репозитория из удалённого репозитория вводим команду:
